...
describe("Test renderTopLanguages helper functions", () => {
    ...
    it("cartesianToPolar", () => {
        ...
        expect(
            cartesianToPolar(100, 100, 40, 100.00000000000001),
        ).toStrictEqual({
            radius: 60,
            angleInDegrees: 180,
        });
        ...
        expect(
            cartesianToPolar(100, 100, 160, 99.99999999999999),
        ).toStrictEqual({
            radius: 60,
            angleInDegrees: 360,
        });
    ...
    it("getDefaultLanguagesCountByLayout", () => {
        ...
        expect(
            getDefaultLanguagesCountByLayout({ layout: "donut" }),
        ).toStrictEqual(5);
        expect(
            getDefaultLanguagesCountByLayout({ layout: "donut-vertical" }),
        ).toStrictEqual(6);
        expect(
            getDefaultLanguagesCountByLayout({ layout: "pie" }),
        ).toStrictEqual(6);
    });
});
...
describe("Test renderTopLanguages", () => {
    it("should render correctly", () => {
        ...
        ).toHaveTextContent("HTML");
        expect(
            queryAllByTestId(document.body, "lang-name")[1],
        ).toHaveTextContent("javascript");
        expect(
            queryAllByTestId(document.body, "lang-name")[2],
        ).toHaveTextContent("css");
        expect(
            queryAllByTestId(document.body, "lang-progress")[0],
        ).toHaveAttribute("width", "40%");
        expect(
            queryAllByTestId(document.body, "lang-progress")[1],
        ).toHaveAttribute("width", "40%");
        expect(
            queryAllByTestId(document.body, "lang-progress")[2],
    ...
    it("should hide languages when hide is passed", () => {
        ...
        expect(
            queryAllByTestId(document.body, "lang-name")[0],
        ).toBeInTheDocument("javascript");
        expect(
            queryAllByTestId(document.body, "lang-name")[1],
        ).toBeInTheDocument("css");
        expect(
            queryAllByTestId(document.body, "lang-name")[2],
        ).not.toBeDefined();
    ...
    it("should render with all the themes", () => {
        Object.keys(themes).forEach((name) => {
            ...
            expect(headerStyles.fill.trim()).toBe(
    ...
    it("should render with layout compact", () => {
        ...
        expect(
            queryAllByTestId(document.body, "lang-name")[1],
        ).toHaveTextContent("javascript 40.00%");
        expect(
            queryAllByTestId(document.body, "lang-progress")[1],
        ).toHaveAttribute("width", "100");
    ...
    it("should render with layout donut", () => {
        ...
        expect(
            queryAllByTestId(document.body, "lang-donut")[0],
        ).toHaveAttribute("size", "40");
        ...
        expect(
            queryAllByTestId(document.body, "lang-donut")[1],
        ).toHaveAttribute("size", "40");
        ...
        expect(
            queryAllByTestId(document.body, "lang-donut")[2],
        ).toHaveAttribute("size", "20");
        ...
        expect(HTMLLangPercent + javascriptLangPercent + cssLangPercent).toBe(
            100,
        );
        ...
        expect(
            queryAllByTestId(document.body, "lang-name")[0],
        ).toHaveTextContent("HTML 100.00%");
        expect(
            queryAllByTestId(document.body, "lang-donut")[0],
        ).toHaveAttribute("size", "100");
