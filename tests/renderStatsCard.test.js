...
describe("Test renderStatsCard", () => {
    it("should render correctly", () => {
        ...
        expect(
            queryByTestId(document.body, "prs_merged"),
        ).not.toBeInTheDocument();
        expect(
    ...
    it("should hide_rank", () => {
        ...
        expect(
            queryByTestId(document.body, "rank-circle"),
        ).not.toBeInTheDocument();
    });
    ...
    it("should render custom ring_color properly", () => {
        ...
        expect(statClassStyles.fill.trim()).toBe(`#${customColors.text_color}`);
        expect(iconClassStyles.fill.trim()).toBe(`#${customColors.icon_color}`);
        expect(rankCircleStyles.stroke.trim()).toBe(
    ...
    it("should show the rank percentile", () => {
        ...
        expect(
            queryByTestId(document.body, "percentile-top-header"),
        ).toBeDefined();
        expect(
            queryByTestId(
                document.body,
        ...
        expect(
            queryByTestId(document.body, "rank-percentile-text"),
        ).toBeDefined();
        expect(
            queryByTestId(
                document.body,
