...
describe("Test renderRepoCard", () => {
    it("should render correctly", () => {
        ...
        expect(queryByTestId(document.body, "stargazers")).toHaveTextContent(
            "38k",
        );
        expect(queryByTestId(document.body, "forkcount")).toHaveTextContent(
            "100",
        );
    ...
    it("should trim description", () => {
        ...
        expect(
            document.getElementsByClassName("description")[0].children[0]
                .textContent,
        ).toBe("The quick brown fox jumps over the lazy dog is an");

        expect(
            document.getElementsByClassName("description")[0].children[1]
                .textContent,
        ...
        expect(
            document.getElementsByClassName("description")[0],
        ).toHaveTextContent("Small text should not trim");
    });
    ...
    it("should render emojis", () => {
        ...
        expect(
            document.getElementsByClassName("description")[0],
        ).toHaveTextContent("This is a text with a 💩 poo emoji");
    });
    ...
    it("should hide language if primaryLanguage is null & fallback to correct values", () => {
        ...
        expect(
            queryByTestId(document.body, "primary-lang"),
        ).toBeInTheDocument();
        expect(queryByTestId(document.body, "lang-color")).toHaveAttribute(
            "fill",
            "#333",
    ...
    it("should fallback to default description", () => {
        ...
        expect(
            document.getElementsByClassName("description")[0],
        ).toHaveTextContent("No description provided");
    });
