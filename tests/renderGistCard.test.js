...
describe("test renderGistCard", () => {
    it("should render correctly", () => {
        ...
        expect(queryByTestId(document.body, "starsCount")).toHaveTextContent(
            "163",
        );
        expect(queryByTestId(document.body, "forksCount")).toHaveTextContent(
            "19",
        );
    ...
    it("should render emojis in description", () => {
        ...
        expect(
            document.getElementsByClassName("description")[0],
        ).toHaveTextContent("This is a test gist description with ❤️ emoji.");
    });
